...
function employee(name, salary) {
    ...
    return {
		sayHello: function () {
			return 'hello' + ' ' + employeeA.name
		}
    };
    return {
    	increaseSalary: function (n) {
    		var total = n + salary;
    		return 'your salary is: $' + total;
    	}
    }
...
function max(arr) {
	var max = arr[0];
	return reduce(arr, function(element) {
	// console.log(max);
		if (element > max) {
			max = element;
		}
...
////////////////// so soooorry I didn't do well if there is aby chance i can do this assesment again i assure you i will be ready ///////////////////////////